...
const steps = [
  {
    icon: (
      <svg className="h-7 w-7" fill="currentColor" viewBox="0 0 384 512">
    ...
    title: "Planifica",
    description:
      "Obtén un plan personalizado adaptado a los objetivos de tu empresa.",
  },
  {
    icon: (
    ...
    title: "Reserva",
    description:
      "Deja la logística en nuestras manos, desde la reserva del lugar hasta la gestión de proveedores.",
  },
  {
    icon: (
    ...
    title: "Ejecuta",
    description:
      "Disfruta del evento con actualizaciones en tiempo real y soporte profesional.",
  },
];
        ...
        <div className="flex flex-col gap-[30px] md:flex-1">
          <div className="flex flex-col gap-[8px] text-center md:gap-[12px] md:pl-[43px] md:text-left">
            ...
            <h3 className="font-poppins text-[16px] font-semibold text-ebombo-primary md:text-[22px]">
              Haz Realidad El Evento De Tus Sueños En 3 Pasos:
            </h3>
          </div>
